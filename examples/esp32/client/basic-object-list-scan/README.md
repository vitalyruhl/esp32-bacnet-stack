...
```sh
cp examples/esp32/client/basic-object-list-scan/src/secret/secrets.example.h \
  examples/esp32/client/basic-object-list-scan/src/secret/secrets.h
```
...
`examples/esp32/shared/network/Esp32WiFiNetwork.h` helper. Transport and BACnet session
