...
```sh
pio run -d examples/esp32/paired/live-cov/server-wifi -e wifi-com7
pio run -d examples/esp32/paired/live-cov/server-wifi -e wifi-com7 -t upload
...
```sh
pio run -d examples/esp32/paired/live-cov/server-wifi -e wifi-com7-quiet
```
